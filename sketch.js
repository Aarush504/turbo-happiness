...
pig3.body.position= lstone;
bird.body.position= lmango;
bird2.body.position= lmango;
bird3.body.position= lmango;
bird4.body.position= lmango;
bird5.body.position= lmango;

var distance=dist(pig3.body.position.x, pig3.position.y, bird.body.position.x, bird.body.position.y);
